export default function Sidebar({ activeTab, setActiveTab, selectedTier, setSelectedTier, businessName, businessCategory, userEmail, onToggleRecorder, mobileOpen, onClose }) {
  const menuItems = [
    ...
    { id: 'bus', label: 'Multi-Agent Bus', icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33"/></svg>
    )},
    { id: 'whitelabel', label: 'Agency White-Label', icon: (
    ...
    { id: 'marketplace', label: 'Workflow Market', icon: (

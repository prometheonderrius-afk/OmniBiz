...
|---|------|-------|-------------|--------|
| M1 | Core Backend, Vertex AI & Build Hardening | F1, F2, F3, F4, F5: GCP Project ID unification, Vertex AI fallback in `ai-generate.js`, live prompts, `.firebaserc`, eslint ignores | none | PLANNED |
| M2 | Sovereign Offline Sync & Real Onboarding | F6, F7, F8: IndexedDB transaction queue, reconnect replay, real Onboarding step 5 and vertical Firestore seeding | M1 | PLANNED |
